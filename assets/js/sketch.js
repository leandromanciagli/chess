...
function setup() {
  ...
  board = new Board()
  cells = createCells(board.getSize())
  pieces = createPieces(board.getSize()/10)
  teams = {
    whiteTeam: new Team('whiteTeam', true, pieces.whitePieces),
    blackTeam: new Team('blackTeam', false, pieces.blackPieces)
  }
...
function mouseClicked(e) {
  ...
  let turnTeamPieces = board.getTurnTeam().getPieces()
  for (const piece in turnTeamPieces) {
    if (turnTeamPieces[piece].wasSelected(e.offsetX, e.offsetY)) {
      board.selectPiece(turnTeamPieces[piece])
    }
  }
...
{
  let cellSize = boardSize/10
  const color1 = 'brown'
  const color2 = 'white'
  let northWestCornerPosX = windowWidth/2 - boardSize/2
  let northWestCornerPosY = windowHeight/2 - boardSize/2
  ...
  let a1 = new PlayableCell(color1, 'A1', '1', 'A', cellSize, northWestCornerPosX+(cellSize*1), northWestCornerPosY+(cellSize*8))
  let a2 = new PlayableCell(color2, 'A2', '2', 'A', cellSize, northWestCornerPosX+(cellSize*1), northWestCornerPosY+(cellSize*7))
  let a3 = new PlayableCell(color1, 'A3', '3', 'A', cellSize, northWestCornerPosX+(cellSize*1), northWestCornerPosY+(cellSize*6))
  let a4 = new PlayableCell(color2, 'A4', '4', 'A', cellSize, northWestCornerPosX+(cellSize*1), northWestCornerPosY+(cellSize*5))
  let a5 = new PlayableCell(color1, 'A5', '5', 'A', cellSize, northWestCornerPosX+(cellSize*1), northWestCornerPosY+(cellSize*4))
  let a6 = new PlayableCell(color2, 'A6', '6', 'A', cellSize, northWestCornerPosX+(cellSize*1), northWestCornerPosY+(cellSize*3))
  let a7 = new PlayableCell(color1, 'A7', '7', 'A', cellSize, northWestCornerPosX+(cellSize*1), northWestCornerPosY+(cellSize*2))
  let a8 = new PlayableCell(color2, 'A8', '8', 'A', cellSize, northWestCornerPosX+(cellSize*1), northWestCornerPosY+(cellSize*1))
  let b1 = new PlayableCell(color2, 'B1', '1', 'B', cellSize, northWestCornerPosX+(cellSize*2), northWestCornerPosY+(cellSize*8))
  let b2 = new PlayableCell(color1, 'B2', '2', 'B', cellSize, northWestCornerPosX+(cellSize*2), northWestCornerPosY+(cellSize*7))
  let b3 = new PlayableCell(color2, 'B3', '3', 'B', cellSize, northWestCornerPosX+(cellSize*2), northWestCornerPosY+(cellSize*6))
  let b4 = new PlayableCell(color1, 'B4', '4', 'B', cellSize, northWestCornerPosX+(cellSize*2), northWestCornerPosY+(cellSize*5))
  let b5 = new PlayableCell(color2, 'B5', '5', 'B', cellSize, northWestCornerPosX+(cellSize*2), northWestCornerPosY+(cellSize*4))
  let b6 = new PlayableCell(color1, 'B6', '6', 'B', cellSize, northWestCornerPosX+(cellSize*2), northWestCornerPosY+(cellSize*3))
  let b7 = new PlayableCell(color2, 'B7', '7', 'B', cellSize, northWestCornerPosX+(cellSize*2), northWestCornerPosY+(cellSize*2))
  let b8 = new PlayableCell(color1, 'B8', '8', 'B', cellSize, northWestCornerPosX+(cellSize*2), northWestCornerPosY+(cellSize*1))
  let c1 = new PlayableCell(color1, 'C1', '1', 'C', cellSize, northWestCornerPosX+(cellSize*3), northWestCornerPosY+(cellSize*8))
  let c2 = new PlayableCell(color2, 'C2', '2', 'C', cellSize, northWestCornerPosX+(cellSize*3), northWestCornerPosY+(cellSize*7))
  let c3 = new PlayableCell(color1, 'C3', '3', 'C', cellSize, northWestCornerPosX+(cellSize*3), northWestCornerPosY+(cellSize*6))
  let c4 = new PlayableCell(color2, 'C4', '4', 'C', cellSize, northWestCornerPosX+(cellSize*3), northWestCornerPosY+(cellSize*5))
  let c5 = new PlayableCell(color1, 'C5', '5', 'C', cellSize, northWestCornerPosX+(cellSize*3), northWestCornerPosY+(cellSize*4))
  let c6 = new PlayableCell(color2, 'C6', '6', 'C', cellSize, northWestCornerPosX+(cellSize*3), northWestCornerPosY+(cellSize*3))
  let c7 = new PlayableCell(color1, 'C7', '7', 'C', cellSize, northWestCornerPosX+(cellSize*3), northWestCornerPosY+(cellSize*2))
  let c8 = new PlayableCell(color2, 'C8', '8', 'C', cellSize, northWestCornerPosX+(cellSize*3), northWestCornerPosY+(cellSize*1))
  let d1 = new PlayableCell(color2, 'D1', '1', 'D', cellSize, northWestCornerPosX+(cellSize*4), northWestCornerPosY+(cellSize*8))
  let d2 = new PlayableCell(color1, 'D2', '2', 'D', cellSize, northWestCornerPosX+(cellSize*4), northWestCornerPosY+(cellSize*7))
  let d3 = new PlayableCell(color2, 'D3', '3', 'D', cellSize, northWestCornerPosX+(cellSize*4), northWestCornerPosY+(cellSize*6))
  let d4 = new PlayableCell(color1, 'D4', '4', 'D', cellSize, northWestCornerPosX+(cellSize*4), northWestCornerPosY+(cellSize*5))
  let d5 = new PlayableCell(color2, 'D5', '5', 'D', cellSize, northWestCornerPosX+(cellSize*4), northWestCornerPosY+(cellSize*4))
  let d6 = new PlayableCell(color1, 'D6', '6', 'D', cellSize, northWestCornerPosX+(cellSize*4), northWestCornerPosY+(cellSize*3))
  let d7 = new PlayableCell(color2, 'D7', '7', 'D', cellSize, northWestCornerPosX+(cellSize*4), northWestCornerPosY+(cellSize*2))
  let d8 = new PlayableCell(color1, 'D8', '8', 'D', cellSize, northWestCornerPosX+(cellSize*4), northWestCornerPosY+(cellSize*1))
  let e1 = new PlayableCell(color1, 'E1', '1', 'E', cellSize, northWestCornerPosX+(cellSize*5), northWestCornerPosY+(cellSize*8))
  let e2 = new PlayableCell(color2, 'E2', '2', 'E', cellSize, northWestCornerPosX+(cellSize*5), northWestCornerPosY+(cellSize*7))
  let e3 = new PlayableCell(color1, 'E3', '3', 'E', cellSize, northWestCornerPosX+(cellSize*5), northWestCornerPosY+(cellSize*6))
  let e4 = new PlayableCell(color2, 'E4', '4', 'E', cellSize, northWestCornerPosX+(cellSize*5), northWestCornerPosY+(cellSize*5))
  let e5 = new PlayableCell(color1, 'E5', '5', 'E', cellSize, northWestCornerPosX+(cellSize*5), northWestCornerPosY+(cellSize*4))
  let e6 = new PlayableCell(color2, 'E6', '6', 'E', cellSize, northWestCornerPosX+(cellSize*5), northWestCornerPosY+(cellSize*3))
  let e7 = new PlayableCell(color1, 'E7', '7', 'E', cellSize, northWestCornerPosX+(cellSize*5), northWestCornerPosY+(cellSize*2))
  let e8 = new PlayableCell(color2, 'E8', '8', 'E', cellSize, northWestCornerPosX+(cellSize*5), northWestCornerPosY+(cellSize*1))
  let f1 = new PlayableCell(color2, 'F1', '1', 'F', cellSize, northWestCornerPosX+(cellSize*6), northWestCornerPosY+(cellSize*8))
  let f2 = new PlayableCell(color1, 'F2', '2', 'F', cellSize, northWestCornerPosX+(cellSize*6), northWestCornerPosY+(cellSize*7))
  let f3 = new PlayableCell(color2, 'F3', '3', 'F', cellSize, northWestCornerPosX+(cellSize*6), northWestCornerPosY+(cellSize*6))
  let f4 = new PlayableCell(color1, 'F4', '4', 'F', cellSize, northWestCornerPosX+(cellSize*6), northWestCornerPosY+(cellSize*5))
  let f5 = new PlayableCell(color2, 'F5', '5', 'F', cellSize, northWestCornerPosX+(cellSize*6), northWestCornerPosY+(cellSize*4))
  let f6 = new PlayableCell(color1, 'F6', '6', 'F', cellSize, northWestCornerPosX+(cellSize*6), northWestCornerPosY+(cellSize*3))
  let f7 = new PlayableCell(color2, 'F7', '7', 'F', cellSize, northWestCornerPosX+(cellSize*6), northWestCornerPosY+(cellSize*2))
  let f8 = new PlayableCell(color1, 'F8', '8', 'F', cellSize, northWestCornerPosX+(cellSize*6), northWestCornerPosY+(cellSize*1))
  let g1 = new PlayableCell(color1, 'G1', '1', 'G', cellSize, northWestCornerPosX+(cellSize*7), northWestCornerPosY+(cellSize*8))
  let g2 = new PlayableCell(color2, 'G2', '2', 'G', cellSize, northWestCornerPosX+(cellSize*7), northWestCornerPosY+(cellSize*7))
  let g3 = new PlayableCell(color1, 'G3', '3', 'G', cellSize, northWestCornerPosX+(cellSize*7), northWestCornerPosY+(cellSize*6))
  let g4 = new PlayableCell(color2, 'G4', '4', 'G', cellSize, northWestCornerPosX+(cellSize*7), northWestCornerPosY+(cellSize*5))
  let g5 = new PlayableCell(color1, 'G5', '5', 'G', cellSize, northWestCornerPosX+(cellSize*7), northWestCornerPosY+(cellSize*4))
  let g6 = new PlayableCell(color2, 'G6', '6', 'G', cellSize, northWestCornerPosX+(cellSize*7), northWestCornerPosY+(cellSize*3))
  let g7 = new PlayableCell(color1, 'G7', '7', 'G', cellSize, northWestCornerPosX+(cellSize*7), northWestCornerPosY+(cellSize*2))
  let g8 = new PlayableCell(color2, 'G8', '8', 'G', cellSize, northWestCornerPosX+(cellSize*7), northWestCornerPosY+(cellSize*1))
  let h1 = new PlayableCell(color2, 'H1', '1', 'H', cellSize, northWestCornerPosX+(cellSize*8), northWestCornerPosY+(cellSize*8))
  let h2 = new PlayableCell(color1, 'H2', '2', 'H', cellSize, northWestCornerPosX+(cellSize*8), northWestCornerPosY+(cellSize*7))
  let h3 = new PlayableCell(color2, 'H3', '3', 'H', cellSize, northWestCornerPosX+(cellSize*8), northWestCornerPosY+(cellSize*6))
  let h4 = new PlayableCell(color1, 'H4', '4', 'H', cellSize, northWestCornerPosX+(cellSize*8), northWestCornerPosY+(cellSize*5))
  let h5 = new PlayableCell(color2, 'H5', '5', 'H', cellSize, northWestCornerPosX+(cellSize*8), northWestCornerPosY+(cellSize*4))
  let h6 = new PlayableCell(color1, 'H6', '6', 'H', cellSize, northWestCornerPosX+(cellSize*8), northWestCornerPosY+(cellSize*3))
  let h7 = new PlayableCell(color2, 'H7', '7', 'H', cellSize, northWestCornerPosX+(cellSize*8), northWestCornerPosY+(cellSize*2))
  let h8 = new PlayableCell(color1, 'H8', '8', 'H', cellSize, northWestCornerPosX+(cellSize*8), northWestCornerPosY+(cellSize*1))
...
function createPieces(pieceSize)
{
  ...
  // White Pieces
  let whiteKing    = new King(wKing,     "whiteKing",    pieceSize, cells["E1"], 1)
  let whiteQueen   = new Queen(wQueen,   "whiteQueen",   pieceSize, cells["D1"], 1)
  let whiteTower1  = new Tower(wTower,   "whiteTower1",  pieceSize, cells["A1"], 1)
  let whiteTower2  = new Tower(wTower,   "whiteTower2",  pieceSize, cells["H1"], 1)
  let whiteBishop1 = new Bishop(wBishop, "whiteBishop1", pieceSize, cells["C1"], 1)
  let whiteBishop2 = new Bishop(wBishop, "whiteBishop2", pieceSize, cells["F1"], 1)
  let whiteHorse1  = new Horse(wHorse,   "whiteHorse1",  pieceSize, cells["B1"], 1)
  let whiteHorse2  = new Horse(wHorse,   "whiteHorse2",  pieceSize, cells["G1"], 1)
  let whitePawn1   = new Pawn(wPawn,     "whitePawn1",   pieceSize, cells["A2"], 1)
  let whitePawn2   = new Pawn(wPawn,     "whitePawn2",   pieceSize, cells["B2"], 1)
  let whitePawn3   = new Pawn(wPawn,     "whitePawn3",   pieceSize, cells["C2"], 1)
  let whitePawn4   = new Pawn(wPawn,     "whitePawn4",   pieceSize, cells["D2"], 1)
  let whitePawn5   = new Pawn(wPawn,     "whitePawn5",   pieceSize, cells["E2"], 1)
  let whitePawn6   = new Pawn(wPawn,     "whitePawn6",   pieceSize, cells["F2"], 1)
  let whitePawn7   = new Pawn(wPawn,     "whitePawn7",   pieceSize, cells["G2"], 1)
  let whitePawn8   = new Pawn(wPawn,     "whitePawn8",   pieceSize, cells["H2"], 1)

  // Black Pieces
  let blackKing    = new King(bKing,     "blackKing",    pieceSize, cells["E8"], 2)
  let blackQueen   = new Queen(bQueen,   "blackQueen",   pieceSize, cells["D8"], 2)
  let blackTower1  = new Tower(bTower,   "blackTower1",  pieceSize, cells["A8"], 2)
  let blackTower2  = new Tower(bTower,   "blackTower2",  pieceSize, cells["H8"], 2)
  let blackBishop1 = new Bishop(bBishop, "blackBishop1", pieceSize, cells["C8"], 2)
  let blackBishop2 = new Bishop(bBishop, "blackBishop2", pieceSize, cells["F8"], 2)
  let blackHorse1  = new Horse(bHorse,   "blackHorse1",  pieceSize, cells["B8"], 2)
  let blackHorse2  = new Horse(bHorse,   "blackHorse2",  pieceSize, cells["G8"], 2)
  let blackPawn1   = new Pawn(bPawn,     "blackPawn1",   pieceSize, cells["A7"], 2)
  let blackPawn2   = new Pawn(bPawn,     "blackPawn2",   pieceSize, cells["B7"], 2)
  let blackPawn3   = new Pawn(bPawn,     "blackPawn3",   pieceSize, cells["C7"], 2)
  let blackPawn4   = new Pawn(bPawn,     "blackPawn4",   pieceSize, cells["D7"], 2)
  let blackPawn5   = new Pawn(bPawn,     "blackPawn5",   pieceSize, cells["E7"], 2)
  let blackPawn6   = new Pawn(bPawn,     "blackPawn6",   pieceSize, cells["F7"], 2)
  let blackPawn7   = new Pawn(bPawn,     "blackPawn7",   pieceSize, cells["G7"], 2)
  let blackPawn8   = new Pawn(bPawn,     "blackPawn8",   pieceSize, cells["H7"], 2)
  ...
  for (const teamPieces in pieces) {
    for (const piece in pieces[teamPieces]) {
      pieces[teamPieces][piece].getActualCell().setActualPiece(pieces[piece])
    }
  }
